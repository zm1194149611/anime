...
public class ZipUtil {
	...
	/**修改文件目录*/
	private static final String UPDATE_PATH_NAME = "\\META-INF\\channel";
	/**解压源文件目录*/
	...
	/**JDK BIN 目录*/
	private static final String JDK_BIN_PATH = "C:\\Program Files\\Java\\jdk1.7.0_80\\bin";
	/**密钥 目录*/
    ...
    */  
	...
	public static void main(String[] args)throws Exception{
		...
		String srcPath = "E:\\apktest\\demo2-debug.apk";
		String channelCode = "_20180106";
		...
		String path = buffer.append(parentPath).append(SOURCE_PATH_NAME)
				.append(prefixName).append(UPDATE_PATH_NAME).append(channelCode).toString();
