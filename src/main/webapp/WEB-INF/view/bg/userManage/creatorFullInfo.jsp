...
<div class="pd-20">
	...
	<span class="identity_add_footer" style="margin-top:20px;">
		SYE:<input type="radio" name="choice" value="1" <c:if test="${flag==1 }">checked="checked"</c:if> >是
		<input type="radio" name="choice" value="0" <c:if test="${flag==0 }">checked="checked"</c:if> >否
	</span>
	<!-- 按钮 -->
	<div class="identity_add_footer">
		<a class="identity_add_btn" onClick="approve(1,'${userFullInfo.id}')" href="javascript:;" title="通过">通过</a>
