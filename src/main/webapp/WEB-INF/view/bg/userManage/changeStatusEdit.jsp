	...
	<body>
		<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页
			 ...
			 <span class="c-gray en">&gt;</span> 身份修改 
		</nav>
		
		<form action="saveRole" id="pointForm" class="form" method="post">
			<div class="row cl">
				<span class="form-label col-3" style="text-align:right;">用户身份：&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<div class="formControls col-9">
					<select name="role" id="role" class="input-text" style="width:250px;">
						<c:forEach var="i" begin="0" end="6" step="1">
							<c:if test="${i!=2}">
							<option value="${i}"><spring:message code="role.role${i}" /></option>
							</c:if>
						</c:forEach>
						<option value="100"><spring:message code="role.role100" /></option>
					</select>
				</div>
