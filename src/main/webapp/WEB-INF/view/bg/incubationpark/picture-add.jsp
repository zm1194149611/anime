...
<body>
<div class="pd-20">
<input type="hidden" value="${incubationParkId}" id="incubationParkId"/>
...
$(function(){
	...
	$btn = $("#btn-star"),
	state = "pending",
	incubationParkIdT = $("#incubationParkId").attr("value");
	uploader;
	...
	var uploader = WebUploader.create({
		...
		// 文件接收服务端。
		server: 'uploadImagesAdd?incubationParkId='+incubationParkIdT,
