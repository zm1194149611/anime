...
<header>
    <div class="blackLayer">
        <img id="proPic" src="${comic.imgUrl }">
        <p id="proName">${comic.title }</p>
        <p class="proMan">作者：<label>${comic.author }</label></p>
        <p class="proData">
        	<c:forEach var="tag" items="${comic.tagList}">
...
<article>
    ...
    <div class="font bgLine" onclick="">
    	
	   &nbsp; &nbsp; 百度云链接：<a href="${comic.resourceUrl }">点击此处获取</a>
    </div>
    <div class="font bgLine" onclick="">
    	
	   &nbsp; &nbsp; 密码：${comic.resourcePassword }
    </div>
