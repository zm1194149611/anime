...
<body>
			...
			<div class="row">
				...
				<div class="col-md-8">
					  <c:forEach var="vdo"   items="${sp }"   varStatus="status">
						<img src="${vdo.file.url }" class="img-responsive" style="float:left;margin-right:3px;margin-bottom:3px;width:100px;height:100px;" alt="Responsive image">
					  </c:forEach></div>
			</div>
		</div>
	</div>
	<div class="modal-footer">
		...
		<button class="btn" onclick = "confirm(${anchor.id},2)" data-dismiss="modal">不合格</button>
		<button class="btn btn-primary" onclick = "confirm(${anchor.id},1)" data-dismiss="modal">通过</button>
	</div>
</body>
</html>