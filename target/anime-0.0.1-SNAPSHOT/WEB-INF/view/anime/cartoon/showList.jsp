    ...
    <script type="text/javascript">
        ...
        var type = "footerAddSubMenu";
	   	...
	   	function loadList(){
	   		...
	   		var url = "${contextPath}/cartoon/querylist?start="+start+"&size="+size; 
...
<header>
    <div class="bgBox">
        <ul class="picBox" id="picBox">
            ...
            <%-- <li>
                <img src="${contextPath}/imgs/banner1.jpg"></a>
                <p class="boxFont"></p>
            </li>
            <li>
                <img src="${contextPath}/imgs/banner2.jpg"></a>
                <p class="boxFont"></p>
            </li>
            <li>
                <img src="${contextPath}/imgs/banner3.jpg"></a>
                <p class="boxFont"></p>
            </li> --%>
        </ul>
...
<article>
    <section>
        ...
        <div class="search" style="padding-bottom:0">
            ...
            <input name="textfield" type="text" id="textfield" placeholder="请输入漫画名称" value="${info.cityName!=null?info.cityName:''}" >
    ...
    function keySearch()
	 {
		key=$('#textfield').val();
		start=0;
		var url = "${contextPath}/cartoon/querylist?start="+start+"&size="+size+"&keySearch="+encodeURI(encodeURI(key)); 
		$.get(url,function(data,status){
