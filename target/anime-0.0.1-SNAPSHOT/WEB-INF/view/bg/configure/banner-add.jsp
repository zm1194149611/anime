...
<div class="pd-20">
	<form method="post" class="form form-horizontal" id="form-article-add">
		...
		<c:if test="${empty syeBanner.syeBannerId}">
			<div class="row cl">
					<span class="form-label col-2"><span class="c-red">*</span>banner位置：</span>
					<div class="formControls col-10">
						<select name="syeBannerLocal" id="syeBannerLocal" class="input-text" style="width:250px;">
			...
			<div class="row cl">
				<span class="form-label col-2">banner链接：</span>
				<div class="formControls col-10">
					<input type="text"  name="syeBannerLink" placeholder="例如 http://www.baidu.com"  value="${syeBanner.syeBannerLink}" id="syeBannerLink" class="input-text" style="width:900px;" />
				</div>
			</div>
			
			<div class="row cl">
				<span class="form-label col-2">banner备注：</span>
				<div class="formControls col-10">
					<input type="text"  name="syeBannerRemark" value="${syeBanner.syeBannerRemark}" id="syeBannerRemark" class="input-text" style="width:900px;" />
				</div>
			</div>
			...
			<c:if test="${!empty syeBanner.syeBannerId}">
				<div class="row cl">
					...
					<div class="formControls col-10">
						<img alt="" class="picture-thumb" id="syeBannerUrl" width="150px" height="100px" src="${contextPath}/pics/${syeBanner.syeBannerUrl}" />
					</div>
				</div>
			</c:if>
			...
			<div id="fileNameHidden">
				<input type="hidden" value="${syeBanner.syeBannerId}" name="syeBannerId" id="syeBannerId"/>
				<input type="hidden" name="syeBannerUrl" value="${syeBanner.syeBannerUrl}" />
			</div>
		</form>
		<br/>
		<div class="row cl">
				<div class="col-10 col-offset-2">
					<button onclick="finish();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 完成</button>
				</div>
			</div>
	</div>
	...
	$(function(){
		...
		$btn = $("#btn-star"),
		state = "pending",
		syeBannerIdT = $("#syeBannerId").attr("value");
		uploader;
		...
		var uploader = WebUploader.create({
			...
			// 文件接收服务端。
			server: 'uploadImagesAdd?syeBannerId='+syeBannerIdT,
	...
	(function( $ ){
	    ...
	    $(function() {
	        ...
	        uploader.on('uploadSuccess',function(file,json){
	        	$("input[name='syeBannerUrl']").val(json.result);
	        	$("#syeBannerUrl").attr("src","${contextPath}/pics/"+json.result);
	        });
