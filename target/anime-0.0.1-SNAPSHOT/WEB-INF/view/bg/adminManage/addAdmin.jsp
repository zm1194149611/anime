...
<html>
	...
	<body>
		...
		<div class="row cl">
			...
			<input type="text" class="input-text" name="name" style="width:260px;" maxlength="10" />
		</div>
		<div class="row cl">
			<span class="form-label col-2" style="text-align:right;">电话号码：</span>
			<input type="text" class="input-text" name="telephone" style="width:260px;" maxlength="11" />
		</div>
		<div class="row cl">
			<span class="form-label col-2" style="text-align:right;">账号：</span>
			<input type="text" class="input-text" name="loginName" style="width:260px;" maxlength="20" />
			<span style="margin-left:5px;color:red;" id="name"></span>
		</div>
		<div class="row cl">
			<span class="form-label col-2" style="text-align:right;">密码：</span>
			<input type="text" class="input-text" name="loginPsw" style="width:260px;" maxlength="26" />
			<!-- <span>111111<input type="hidden" name="loginPsw" value="111111" /></span> -->
		</div>
		
		<div class="row cl" onclick="saveAdmin();">
	...
	<script type="text/javascript">
		function saveAdmin(){
			...
			if(name==""||telephone==""||loginName==""||loginPsw==""){
				alert("请填写所有信息");
				return;
			}
			$.ajax({
				...
				success:function(data, status){
					if(data.exceptionMsg){
						...
						if(data.result){
							alert("添加管理员成功"); 
							location.href="${contextPath}/bg/adminManage/addAdmin";
						}else{
